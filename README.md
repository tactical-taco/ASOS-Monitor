...
## ✨ Key Features
  ...
  * **System Default Toggle:** A dedicated menu option to instantly revert alert sounds to the Windows system default.
...
**Fixed**
  ...
  * Ensured that a blank API response (e.g., for a non-existent station like KZZZ) correctly displays **"Data Unavailable."**
