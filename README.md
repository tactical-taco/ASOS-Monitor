This is an excellent final feature, as stale data is often just as critical as a maintenance flag.

To fully document this enhancement, we'll increment the version to 2.1.3 and update the Key Features and Changelog sections in the README.

Here is the complete, revised README file.
...
⚙️ Installation & Usage
    ...
    Unzip: Extract the contents of the downloaded ZIP file to a location on your computer.

    Run: Execute ASOSMonitor.exe. No installation or external dependencies (beyond Windows itself) are required.
...
Adding Sites
    ...
    Go to File > Add Site(s).

    You can enter a single site ID or paste a bulk list, separated by new lines or commas.
